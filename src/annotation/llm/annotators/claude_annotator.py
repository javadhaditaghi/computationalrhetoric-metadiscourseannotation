...
By considering the section, please analyze the target sentence and provide your metadiscourse annotation."""

        return full_prompt

    def _call_claude(self, prompt: str, max_retries: int = 5, initial_delay: float = 2.0) -> Optional[str]:
        """
        Call Claude API with improved retry logic for handling overloaded servers.
